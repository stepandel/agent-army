...
- [ ] Load `~/.tester-state.json`. Query Linear for tickets in "In Review" or "In Review by Agent" with a linked PR for team {{LINEAR_TEAM}}. Skip tickets already tested at same PR head commit. If none remain → HEARTBEAT_OK.
