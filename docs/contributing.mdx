---
title: "Contributing"
description: "How to contribute to Clawup"
---
...
1. Create an identity directory with `identity.yaml` and workspace files (see [examples/identity/](https://github.com/stepandel/clawup/tree/main/examples/identity) for the format)
