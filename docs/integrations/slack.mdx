...
<AccordionGroup>
  <Accordion title="Juno — Product Manager">
    ```json
    {
      "display_information": {
        "name": "Juno (PM)",
        "description": "Clawup — Product Manager agent"
      },
      "features": {
        "bot_user": {
          "display_name": "Juno",
  ...
  <Accordion title="Titus — Engineer">
    ```json
    {
      "display_information": {
        "name": "Titus (Engineer)",
        "description": "Clawup — Engineer agent"
      },
      "features": {
        "bot_user": {
          "display_name": "Titus",
  ...
  <Accordion title="Scout — QA Tester">
    ```json
    {
      "display_information": {
        "name": "Scout (QA)",
        "description": "Clawup — QA Tester agent"
      },
      "features": {
        "bot_user": {
          "display_name": "Scout",
...
When you run `clawup setup`, these are validated and stored encrypted in Pulumi config (e.g., `pmSlackBotToken`, `pmSlackAppToken`).
