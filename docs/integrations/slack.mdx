...
4. Paste the manifest below (update the `name` and `display_name` for each agent)

<Tip>
The `agent-army init` wizard copies the manifest to your clipboard automatically when you reach the Slack setup step.
</Tip>
