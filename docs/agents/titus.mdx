...
Titus is the **Engineer** of your Clawup. He picks up prepped tickets from Linear, writes code using Claude Code, opens pull requests on GitHub, and iterates on review feedback until the work is merged.
